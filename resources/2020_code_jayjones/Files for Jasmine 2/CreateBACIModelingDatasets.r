...
# OSS
  ...
  xo13 <- read.csv(paste(dname, "OSS detections and covariates 2013 - stacked.csv", sep=""))
  xo14 <- read.csv(paste(dname, "OSS detections and covariates 2014 - stacked.csv", sep=""))
  xo15 <- read.csv(paste(dname, "OSS detections and covariates 2015 - stacked.csv", sep=""))
  xo16 <- read.csv(paste(dname, "OSS detections and covariates 2016 - stacked.csv", sep=""))
  xo17 <- read.csv(paste(dname, "OSS detections and covariates 2017 - stacked.csv", sep=""))
  xo18 <- read.csv(paste(dname, "OSS detections and covariates 2018 - stacked.csv", sep=""))
  xo19 <- read.csv(paste(dname, "OSS detections and covariates 2019 - stacked.csv", sep=""))
...
# ENES
  ...
  xe13 <- read.csv(paste(dname, "ENES detections and covariates 2013 - stacked.csv", sep=""))
  xe14 <- read.csv(paste(dname, "ENES detections and covariates 2014 - stacked.csv", sep=""))
  xe15 <- read.csv(paste(dname, "ENES detections and covariates 2015 - stacked.csv", sep=""))
  xe16 <- read.csv(paste(dname, "ENES detections and covariates 2016 - stacked.csv", sep=""))
  xe17 <- read.csv(paste(dname, "ENES detections and covariates 2017 - stacked.csv", sep=""))
  xe18 <- read.csv(paste(dname, "ENES detections and covariates 2018 - stacked.csv", sep=""))
  xe19 <- read.csv(paste(dname, "ENES detections and covariates 2019 - stacked.csv", sep=""))
