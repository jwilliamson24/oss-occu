...
<qgis version="3.40.2-Bratislava">
  <identifier>2013_All_Units_FeatureToPoin</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>2013_All_Units_FeatureToPoin</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" name="Shapefile" type="Local Area Network" url="file://\\ORALBARMS01\Josh\OR_Slender_Salamander_Project\2013 shapefiles\2013_All_Units_FeatureToPoin.shp" mimeType="" description="" format=""/>
  </links>
  <dates/>
  <fees></fees>
